...
| mask-aws-access-key-id        | Whether to mask the AWS access key ID as a GitHub secret. Defaults to true. Set to false to leave the access key ID unmasked in logs and outputs.                                                                                                                                                                                                                                                                                      | No       |
