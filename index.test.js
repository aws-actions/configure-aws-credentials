...
describe('Configure AWS Credentials', () => {
    ...
    test('basic role assumption with output credentials', async () => {
        ...
        expect(core.setOutput).toHaveBeenNthCalledWith(6, 'aws-default-region', FAKE_REGION);
        expect(core.setOutput).toHaveBeenNthCalledWith(7, 'aws-region', FAKE_REGION);
        expect(core.setOutput).toHaveBeenNthCalledWith(8, 'aws-access-key-id', FAKE_STS_ACCESS_KEY_ID);
        expect(core.setOutput).toHaveBeenNthCalledWith(9, 'aws-secret-access-key', FAKE_STS_SECRET_ACCESS_KEY);
        expect(core.setOutput).toHaveBeenNthCalledWith(10, 'aws-session-token', FAKE_STS_SESSION_TOKEN);
